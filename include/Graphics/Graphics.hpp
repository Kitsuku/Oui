...
class Graphics
{
		...
		private:
			...
			void	displayCharacter(
				...
				const Positions &sizeMap);
			void	createCharactersNode
				(const std::vector<ACharacter *> &Char,
				const Positions &sizeMap);
			void	displayFirstCharacter(ACharacter *character,
				const Positions &sizeMap);
			void	createAnimeCharacter(
			...
			void	displayMeshBomb(
				...
				const coord_t &coord,
				const Positions &sizeMap);
			void	displayExplosion(Bomb *bomb,
				const Positions &sizeMap);
			void	displayVerticalExplosion(Bomb *bomb,
				const Positions &sizeMap);
			void	displayCube(const std::string&image,
				const Positions &position, const Positions
				&oldSizeMap);
			void	setCube(const std::string &image,
